...
var _careerFootprintJson = require("../../data/dataFootprint/careerFootprint.json");
var _careerFootprintJsonDefault = parcelHelpers.interopDefault(_careerFootprintJson);
var _projectFootprintJson = require("../../data/dataFootprint/projectFootprint.json");
var _projectFootprintJsonDefault = parcelHelpers.interopDefault(_projectFootprintJson);
...
const FootprintDetail = ({ onHover , onLeave  })=>{
    ...
    const sliderContent = (content1, kind)=>{
        ...
        }, content1.map((content)=>/*#__PURE__*/ _reactDefault.default.createElement(_swiperReactJs.SwiperSlide, {
                key: content.id
    ...
    }, sliderContent(_careerFootprintJsonDefault.default.career, 'left')), /*#__PURE__*/ _reactDefault.default.createElement("div", {
    ...
    }, sliderContent(_projectFootprintJsonDefault.default.project, 'right'))))));
};
_s(FootprintDetail, "xInVq63rBaGlSwDZ6nY9n7Tcx2I=", false, function() {
    return [
...
},{"react":"4mchR","gsap":"2aTR0","./textSlider.scss":"ojOW7","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"ojOW7":[function() {},{}],"foha8":[function(require,module,exports) {
...
},{}],"hnIei":[function(require,module,exports) {
...
},{}]},["emU3S","jHgrH"], null, "parcelRequire2041")
