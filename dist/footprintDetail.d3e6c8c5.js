...
},{"react-refresh/runtime":"bL4SD"}],"jbF2B":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "ee960438d3e6c8c5";
"use strict";
...
},{}],"31WEf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>_footprintDetailDefault.default
);
var _footprintDetail = require("./footprintDetail");
var _footprintDetailDefault = parcelHelpers.interopDefault(_footprintDetail);

},{"./footprintDetail":"cLcpc","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"cLcpc":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$1e72 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$1e72.prelude(module);
...
var _footprintDetailScss = require("./footprintDetail.scss");
...
var _textSlider = require("../../components/textSlider");
var _textSliderDefault = parcelHelpers.interopDefault(_textSlider);
var _s = $RefreshSig$();
...
const project = [
    {
        ...
        text: '삼성의 전 직원이 사용하는 기존 Knox Portal을 React를 사용하여 새롭게 개발하는 프로젝트입니다. Material-UI를 지향하는 Knox 전용 공통 컴포넌트들과 해당 컴포넌트로 이루어진 일부 모듈들을 개발하였습니다. 기존의 삼성SDS의 Knox Portal 팀은 React 및 컴포넌트 형식의 디자인/개발 경험이 전혀 없었기 때문에 현장관리자로서 UX와 개발 방향을 짚어드리며 작업하였습니다.'
    },
    {
        id: 7,
        keyword: '# Project',
    ...
    },
    {
        ...
        text: 'Online과 Offline의 분리가 명확하고 다양한 권한 관리와 보안정책이 도입된 암호화폐 관리 서비스입니다. 프로젝트 초기에는 디자이너 없이 Material-UI 기능과 디자인을 그대로 사용하여 개발되었으나, 제가 계약된 당시에는 디자이너가 와서 디자인을 적용해야 했습니다. 기존에 작성된 코드는 이미 대부분 Material-UI에서 제공되는 컴포넌트들로 구성되어 있었기 때문에 해당 컴포넌트들에서 디자인 요소를 제거한 뒤 새로 스타일을 입히거나 오버라이드 하여 작업하였습니다.'
    },
    {
        id: 5,
        keyword: '# Project',
        title: '암호화폐 웹 레그/전산관리 솔루션 기획 및 개발',
        ...
        text: '클라이언트의 요청으로 회원 및 보유 암호화폐를 관리하는 웹 사이트를 개발하였습니다. 회원 간의 조직도를 웹상에서 표현하기 위해 OrgChart 기능을 도입하였고 조직도가 상당한 분량의 데이터를 표현해야 하므로 Zoom In/Out 기능과 Drag 기능을 추가로 개발했습니다.'
    },
    {
        id: 4,
        keyword: '# Project',
        ...
        text: '설립되고 몇 년이나 흘렀지만 회사를 소개하는 웹 사이트가 없었습니다. 대표와 상의하여 다양한 문구를 직접 작성하고 메인화면부터 페이지 구성, 자잘한 동적 효과 등을 기획하였습니다. 당시 솔루션 개발을 동시에 하고 있었으므로 개발 자체는 직접 하지 않았습니다.'
    },
    {
        id: 3,
        keyword: '# Project',
        title: '암호화폐 웹 소개/웹 판매 사이트 기획 및 개발',
        date: '2019.03 ~ 2019.06',
        summary: [
            '웹 소개 사이트 2개 / 웹 판매 사이트 2개',
            'Bootstrap 기반 반응형 레이아웃',
            'JQuery로 개발',
            'GSAP로 동적효과 구현',
            '타이머 및 프로그레스 바 기능 도입', 
        ],
        text: '클라이언트의 요청으로 ICO(Initial Coin Offering), IEO(Initial Exchange Offering) 기능의 웹 사이트를 개발하였습니다. 매끄러운 Parallax 효과를 위해 GSAP를 사용하였고 작은 기기에서도 테이블 형태의 정보를 쉽게 편하게 확인하기 위해 이중 스크롤 레이아웃으로 개발한 특이점이 있습니다.'
    },
    {
        id: 2,
        keyword: '# Project',
        title: '암호화폐 웹 거래소/지갑 기획 및 개발',
        date: '2017 ~ 2019.03',
        summary: [
            '웹 거래소 9개 / 웹 지갑 6개',
            'Bootstrap 기반 반응형 레이아웃',
            'JQuery로 개발',
            'Google reCaptcha 기능 도입',
        ...
        text: '오픈소스 기반의 암호화폐 웹 지갑과 거래소 소스를 지속적으로 개선하여 다양한 기업에 판매하였습니다. 처음에는 프랑스어 주석만 가득하고 기본 거래 기능만 있던 소스를 CodeIgniter로 옮겨와서 Front 단과 Back 단으로 구분하여 개선했습니다. 이후 차트와 새로운 코인 연동, 성능 개선 등을 반복하고, 고객 요청에 따라 다양한 추가 기능을 개발하다 보니 해당 기능들을 옵션 형태로 넣고 빼며 최종적으로는 테마 형태로 디자인들을 추가하여 다양한 솔루션형태로 판매하였습니다. 또한, 사용자들이 소수점 단위의 구입, 구축, 전송 등의 다양한 계산을 해야 하므로 프론트에서 입력값에 따른 계산식을 개발하여 입력값에 즉시 출력되는 입력 제한 또는 계산 결과, 가이드 멘트 등을 개발했습니다. 당시 모든 타 거래소는 PC와 휴대기기 버전을 따로 개발했으나 완전 반응형으로 작업해온 특이점이 있습니다.'
    },
    {
        id: 1,
        keyword: '# Subcontract',
        title: '각종 기업의 소개/운영 사이트 개발',
        date: '2016.02 ~ 2017.12',
        summary: [
            '쇼핑몰 웹 사이트 (일반기업 솔루션 기반)',
            '이사센터 웹 사이트 (Back개발자에게 퍼블리싱 파일 제공)',
            '소규모 소개 웹 사이트 2개 (Wordpress 기반)',
            '일식 요리학원 웹 사이트 (XEboard, Gnuboard 기반)',
            '쇼핑몰 웹 사이트 (Firstmall 기반)',
            '종이액자기업 웹 사이트 (Wordpress 기반)',
            '쇼핑몰 웹 사이트. (Gnuboard 기반)',
            '제약, 바이오 화학분야 기업 소개 웹 사이트 (Wordpress 기반)',
            '플라스마 기술 기업 소개 웹 사이트. (Wordpress 기반)',
            '흥신소 소개 웹 사이트 (Wordpress 기반)', 
        ],
        text: '독학으로 퍼블리싱을 공부하며 지인들과 함께 팀을 꾸려 다양한 외주작업을 했습니다. Back 개발자가 따로 없었으므로 WordPress, Gnuboard 등 다양한 프레임워크를 통해 업무를 진행하였습니다.'
    }, 
];
const ContentText = ({ isActive , idx , keyword , title , date , summary , text ,  })=>{
    const summarys = [];
    summary.forEach((item, i)=>summarys.push(/*#__PURE__*/ _jsxDevRuntime.jsxDEV("span", {
            children: item
        }, item + i, false, {
            fileName: "src/pages/footprintDetail/footprintDetail.js",
            lineNumber: 185,
            columnNumber: 19
        }, undefined))
    );
    return(/*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
        ...
        children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("ul", {
            ...
            children: [
                ...
                text && /*#__PURE__*/ _jsxDevRuntime.jsxDEV("p", {
                    children: text
                }, void 0, false, {
                    fileName: "src/pages/footprintDetail/footprintDetail.js",
                    lineNumber: 197,
...
const FootprintDetail = ({ onHover , onLeave  })=>{
    ...
    const sliderContent = (content1, kind)=>{
        return(/*#__PURE__*/ _jsxDevRuntime.jsxDEV(_swiperReactJs.Swiper, {
            ...
            children: [
                content1.map((content, idx)=>/*#__PURE__*/ _jsxDevRuntime.jsxDEV(_swiperReactJs.SwiperSlide, {
                        children: ({ isActive  })=>/*#__PURE__*/ _jsxDevRuntime.jsxDEV(ContentText, {
                                isActive: isActive,
                                idx: idx,
    ...
    const FootprintDetailGsap = ()=>{
        _scrollTrigger.ScrollTrigger.matchMedia({
            '(min-width: 985px)': ()=>{
                _gsap.gsap.to('.mobile-division', {
                    opacity: 0
                });
            },
            '(max-width: 984px)': ()=>{
                _gsap.gsap.fromTo('.text-slider-left-area', {
                    opacity: 1
                }, {
                    opacity: 0,
                    scrollTrigger: {
                ...
                _gsap.gsap.fromTo('.text-slider-right-area', {
                    opacity: 0
                }, {
                    opacity: 1,
                    scrollTrigger: {
                ...
                _gsap.gsap.fromTo('.mobile-division', {
                    opacity: 1
                }, {
                    opacity: 0,
                    scrollTrigger: {
    ...
    return(/*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
        className: "footprint-detail",
        children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
            className: "container fluid pl-pr-none",
            children: [
                /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                    className: "text-slider-left-area",
                    children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV(_textSliderDefault.default, {
                        text: 'career',
                        type: 'left'
                    }, void 0, false, {
                        fileName: "src/pages/footprintDetail/footprintDetail.js",
                ...
                /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                    className: "text-slider-right-area",
                    children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV(_textSliderDefault.default, {
                        text: 'project&subcontract',
                        type: 'right'
                    }, void 0, false, {
                        fileName: "src/pages/footprintDetail/footprintDetail.js",
                        lineNumber: 343,
                ...
                /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                    ...
                    children: [
                        /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                            className: "col-12 off-l-none col-l-5 career-frame",
                            children: sliderContent(career, 'left')
                        }, void 0, false, {
                            fileName: "src/pages/footprintDetail/footprintDetail.js",
                            lineNumber: 347,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                            className: "col-1 pl-pr-none division-frame",
                            children: [
                                /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                        ...
                        /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                            className: "col-12 col-l-6 project-frame",
                            children: sliderContent(project, 'right')
                        }, void 0, false, {
                            fileName: "src/pages/footprintDetail/footprintDetail.js",
                            lineNumber: 369,
                            columnNumber: 11
...
_s(FootprintDetail, "z7zX2udUC7easxIU+psKaMl4PEA=", false, function() {
    return [
...
_c1 = FootprintDetail;
exports.default = FootprintDetail;
var _c, _c1;
$RefreshReg$(_c, "ContentText");
$RefreshReg$(_c1, "FootprintDetail");

  $parcel$ReactRefreshHelpers$1e72.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"3jZUD","react":"4mchR","react-redux":"lT3ms","../../Modules/commonValue":"14m9M","swiper":"eH5h9","swiper/react/swiper-react.js":"eabGd","gsap":"2aTR0","gsap/ScrollTrigger":"41HI5","./footprintDetail.scss":"jD9Pm","swiper/swiper.scss":"3GX5N","swiper/modules/navigation/navigation.scss":"30lJ4","swiper/modules/pagination/pagination.scss":"1Gpfv","swiper/modules/effect-fade/effect-fade.scss":"iNnHv","../../components/textSlider":"i85Gq","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"eH5h9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * Swiper 7.4.1
...
},{"react":"4mchR","./utils.js":"k42Gf","./use-isomorphic-layout-effect.js":"1KCBW","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"jD9Pm":[function() {},{}],"3GX5N":[function() {},{}],"30lJ4":[function() {},{}],"1Gpfv":[function() {},{}],"iNnHv":[function() {},{}],"i85Gq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>_textSliderDefault.default
);
var _textSlider = require("./textSlider");
var _textSliderDefault = parcelHelpers.interopDefault(_textSlider);

},{"./textSlider":"8UYQy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"8UYQy":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$9515 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$9515.prelude(module);
...
var _reactDefault = parcelHelpers.interopDefault(_react);
var _gsap = require("gsap");
var _textSliderScss = require("./textSlider.scss");
var _s = $RefreshSig$();
const TextSlider = ({ text: text1 , type  })=>{
    _s();
    const textSliderSetting = (text, align)=>{
        ...
        for(let i = 0; i < l; i++)setting = [
            ...
            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                ...
                children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                    ...
                    fileName: "src/components/textSlider/textSlider.js",
                    lineNumber: 18,
                    columnNumber: 9
                }, undefined)
            }, i, false, {
        ...
        for(let i1 = 0; i1 < 11; i1++)settingFrame = [
            ...settingFrame,
            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                className: `text-slider${i1 % 2 == 0 ? '' : ' second-line'}`,
                children: setting
            }, i1, false, {
                fileName: "src/components/textSlider/textSlider.js",
                lineNumber: 22,
    ...
    _react.useEffect(()=>{
        const set = _gsap.gsap.set('.text-content-frame', {
            x: (i)=>i * 100 + '%'
        });
        const leftAnimation = _gsap.gsap.to('.left-content', {
            duration: 70,
            ease: 'none',
            x: "+=500%",
            modifiers: {
                x: _gsap.gsap.utils.unitize((x)=>parseFloat(x) % 500
                )
            },
            repeat: -1
        });
        const rightAnimation = _gsap.gsap.to('.right-content', {
            duration: 130,
            ease: 'none',
            x: "+=300%",
            modifiers: {
                x: _gsap.gsap.utils.unitize((x)=>parseFloat(x) % 300
                )
            },
            repeat: -1
        });
    ...
    return(/*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
        className: `text-slider-frame ${type}`,
        children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
            className: "rotate-frame",
            children: textSliderSetting(text1, type)
        }, void 0, false, {
            fileName: "src/components/textSlider/textSlider.js",
            lineNumber: 65,
            columnNumber: 7
...
_s(TextSlider, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = TextSlider;
exports.default = TextSlider;
var _c;
$RefreshReg$(_c, "TextSlider");

  $parcel$ReactRefreshHelpers$9515.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"3jZUD","react":"4mchR","gsap":"2aTR0","./textSlider.scss":"ojOW7","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"ojOW7":[function() {},{}]},["emU3S","jbF2B"], null, "parcelRequire2041")

//# sourceMappingURL=footprintDetail.d3e6c8c5.js.map
