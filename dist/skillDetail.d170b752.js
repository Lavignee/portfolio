...
const SkillDetail = ({ onHover , onLeave , pageTimer  })=>{
    ...
    const contents = (target, contentKind)=>{
        ...
        return contentKind === 'list' ? content1.map((content)=>/*#__PURE__*/ _reactDefault.default.createElement("li", {
            ...
            }, content.svg === '' ? /*#__PURE__*/ _reactDefault.default.createElement("div", null, content.name) : /*#__PURE__*/ _reactDefault.default.createElement("div", {
