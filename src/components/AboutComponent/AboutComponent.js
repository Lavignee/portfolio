          ...
          <div className='container'>
            ...
            <div className='row about-contents'>
              <div className='col-m-12 col-xl-6 col-w-4'>
                ...
                <div className='type-p'><SplitTextComponent scroll={'about'}>'대부분 이렇게 하니까', '늘 그래왔으니까' 같은 이유로 매번 변함없이 개발하는 것을 정말 싫어합니다. 불편함은 빠르고 합리적으로 처리해야 하고, 갱신된 정보는 함께 일하는 모두와 공유해야 합니다.</SplitTextComponent></div>
              </div>
              <div className='col-m-12 col-xl-6 col-w-4'>
                ...
                <div className='type-p'><SplitTextComponent scroll={'about'}>목적이 정해지고 필요하다고 생각되면, 그게 불가능해 보여도, 큰 힘이 들더라도, 많은 시간이 들더라도 꿋꿋이 해내고 성취감을 얻는 걸 좋아합니다.</SplitTextComponent></div>
              </div>
              <div className='col-m-12 col-xl-6 col-w-4'>
              ...
              <div className='col-m-12 col-xl-6 col-w-4'>
                ...
                <div className='type-p'><SplitTextComponent scroll={'about'}>나를 포장하고, 잘못은 감추는, 앞,뒤 다른 행동을 하지 않습니다. 자신과 상대방 누구에게도 좋지 않다고 생각합니다.</SplitTextComponent></div>
              </div>
              <div className='col-m-12 col-xl-6 col-w-4'>
