...
const lib = [
  { number: '1', id: 'react', name: 'React', workmanship: 4, summary: 'Class 기반일 때부터 React를 익히고 있었지만, 실무에서 사용해볼 기회가 없었습니다. 커스터디 프로젝트에서 Hooks를 주로 사용하며 실무를 겪어보았고, 이번 포트폴리오는 Hooks 기반으로 제작하였습니다. 초기부터 지금까지 React에 변화가 많아 학습 시에 혼란이 많았지만 개발 및 설계는 이제 익숙합니다. Context로의 상태 관리는 주로 하지는 않습니다.', svg: svg.react },
  { number: '2', id: 'redux', name: 'Redux', workmanship: 3, summary: '간단한 상태 값과 트리거등의 역할로 이번 포트폴리오부터 사용하였습니다. 다양한 미들웨어들과 효율적인 사용은 경험이 더 필요할 것 같습니다.', svg: svg.redux },
  { number: '3', id: 'webpack', name: 'Webpack', workmanship: 3, summary: 'React를 처음 익히면서 Webpack을 배우게 되었습니다. 최근에는 개인 프로젝트를 진행하기 위해 webpack 5를 직접 세팅하여 사용해 보았습니다.', svg: svg.webpack },
  { number: '4', id: 'parcel', name: 'Parcel', workmanship: 4, summary: '이번 포트폴리오 개발에 사용한 번들러입니다. Webpack과 비교하여 Learning curve가 적고 바로 사용이 쉬우나 아직 관련 정보나 사례가 좀 적다는 단점을 겪었습니다.', svg: svg.parcel },
  ...
  { number: '7', id: 'i18next', name: 'I18next', workmanship: 5, summary: 'html이나 Javascript 환경, 서버에서 오는 텍스트 등 다양한 번역을 개발해보았습니다.', svg: svg.i18next },
  ...
  { number: '10', id: 'materialui', name: 'Material-UI', workmanship: 4, summary: '커스터디 프로젝트에서 접하게 되었습니다. Bootstrap처럼 React에서 사용되는 프레임워크로 사용이나 커스텀의 방식도 꽤 익숙했다고 생각합니다.', svg: svg.materialui },
  { number: '11', id: 'axios', name: 'Axios', workmanship: 3, summary: '개인 프로젝트에서 주로 다루어보았고, 실무에서는 깊게 사용해볼 기회는 아직 없었습니다. 익히기 쉬웠고 사용도 간편했습니다.', svg: '' },
  { number: '12', id: 'stroybook', name: 'Stroybook', workmanship: 4, summary: '삼성 Knox 프로젝트에서 공통 컴포넌트를 개발하고 다른 개발팀에 사용법을 공유하기 위해 개발하였습니다. 라이브러리 개발에는 적합한 도구입니다.', svg: '' },
];

const tool = [
  { number: '1', id: 'git', name: 'Git', workmanship: 4, summary: '개발자에게는 필수이고 당연히, 또 오랜 시간 사용하고 있지만 터미널에서 cli로 써본 적은 별로 없는 것 같습니다.', svg: svg.git },
  ...
  { number: '5', id: 'jira', name: 'Jira', workmanship: 4, summary: '처음부터 끝까지 세팅해본적은 없지만, 멤버로서 사용에는 아주 익숙합니다. 삼성에서 PL의 역할로써 사용해보기도 했습니다.', svg: svg.jira },
  { number: '6', id: 'figma', name: 'Figma', workmanship: 4, summary: '예전 초기 프로젝트에서 PSD나 AI를 받아서 작업할 때를 제외하고 대부분은 Figma로 디자인을 전달받아 작업하였습니다. ', svg: svg.figma },
  { number: '7', id: 'zeplin', name: 'Zeplin', workmanship: 4, summary: '예전 초기 프로젝트에서 PSD나 AI를 받아서 작업할 때와 삼성 Knox포털 작업 시 기획서의 대용으로 사용하였습니다.', svg: svg.zeplin },
  { number: '8', id: 'netlify', name: 'Netlify', workmanship: 3, summary: '이번 포트폴리오를 올리면서 사용하였는데, Netlify 사이트의 자체 빌드는 에러가 많아, 빌드는 local에서 진행하고 올렸습니다. 그래도 간편하고 성능도 좋은 것 같습니다.', svg: svg.netlify },
  { number: '9', id: 'lighthouse', name: 'Lighthouse', workmanship: 3, summary: '이번 포트폴리오를 개발하며 성능 개선을 위해 사용하였습니다. 이해하기 쉽고 가이드가 자세하게 나와서 사용이 편했습니다.', svg: svg.lighthouse }
];
...
const interest = [
  ...
  { number: '2', id: 'graphql', name: 'GraphQL', workmanship: 2, summary: '개념과 기본 사용법은 익혀두었지만, 실무에서 사용해보진 못했습니다.', svg: svg.graphql },
  ...
  { number: '6', id: 'nginx', name: 'Nginx', workmanship: 1, summary: '아직 직접 다룰 기회가 없었지만 쓰이는 곳이 많아, 시간 나는 대로 익혀둘 생각입니다.', svg: '' },
  // { number: '7', id: 'gatsby', name: 'Gatsby', workmanship: 1, summary: '요즘 꽤 많이 보이는 서비스입니다. 시간이 나면 다뤄볼 생각입니다.', svg: svg.gatsby },
  { number: '8', id: 'webgl', name: 'WebGL', workmanship: 1, summary: '나중에 꼭 다뤄보고 싶은 생각이 있습니다.', svg: svg.webgl },
