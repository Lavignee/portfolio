...
const project = [
  {
    ...
    text: '삼성의 전 직원이 사용하는 기존 Knox Portal을 React를 사용하여 새롭게 개발하는 프로젝트입니다. Material-UI를 지향하는 Knox 전용 공통 컴포넌트들과 해당 컴포넌트로 이루어진 일부 모듈들을 개발하였습니다. 기존의 삼성SDS의 Knox포털팀은 React 및 컴포넌트 형식의 디자인/개발 경험이 전혀 없었기 때문에 현장관리자로써 UX와 개발 방향을 짚어드리며 작업하였습니다.',
  },
  {
    id: 7,
    keyword: '# Project',
