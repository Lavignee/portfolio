...
const career = [
  {
    id: 3, keyword: '# Career', title: '젠나인소프트시스템 (SI 파견 회사)', date: '2021.05 ~ 재직중', summary: ['프론트 개발'], text: ''
  },
  {
    id: 2, keyword: '# Career', title: '볼트러스트 (상주 프리랜서)', date: '2019.12 ~ 2020.04', summary: ['퍼블리싱', '프론트 개발'], text: ''
  },
  {
    id: 1, keyword: '# Career', title: '크리에이티브코드 (설립 멤버)', date: '2016.07 ~ 2019.10', summary: ['웹 서비스 기획', 'UX기획', '디자인 검수', '퍼블리싱', '프론트 개발', '회사 운영 및 인사 관리.'], text: ''
  }
]

const project = [
  {
    id: 8, keyword: '# Project', title: '삼성SDS 차세대 Knox Portal 개발', date: '2021.05 ~ 진행중', summary: ['React 개발', 'Storybook 개발', '공통 컴포넌트 및 템플릿 개발'], text: '삼성의 전 직원이 사용하는 기존 Knox포털을 React로 새로 개발하는 프로젝트입니다. 기존의 삼성SDS의 Knox포털팀은 React 및 컴포넌트 형식의 디자인/개발 경험이 전혀 없었기 때문에 개발 방향부터 일일이 협의하며 진행하였습니다.'
  },
  {
