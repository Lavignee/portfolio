...
export const changeContactState = createAction(CONTACT_STATE, currentContactState => currentContactState);
export const changeContactStateFalse = createAction(CONTACT_STATE_FALSE, currentContactState => currentContactState);
export const changeButtonDelay = createAction(BUTTON_DELAY, currentButtonDelay => currentButtonDelay);
export const changeGnbState = createAction(GNB_STATE, currentGnbState => currentGnbState);
export const changeSwitchAnimation = createAction(SWITCH_ANIMATION, currentSwitchAnimation => currentSwitchAnimation);
export const changeFilmState = createAction(FIRM_STATE, currentFilmState => currentFilmState);
export const smoothTop = createAction(SMOOTH_TOP, currentSmoothTopState => currentSmoothTopState);
export const makeSmoothScroll = createAction(MAKE_SCROLL_STATE, makeScrollState => makeScrollState);
export const checkScrollValue = createAction(CURRENT_SCROLL_VALUE, currentScrollValue => currentScrollValue);
export const checkScrollLimit = createAction(CURRENT_SCROLL_LIMIT, currentScrollLimit => currentScrollLimit);
export const changeGsapState = createAction(GSAP_READY, currentGsapState => currentGsapState);
export const splitTextStart = createAction(SPLIT_TEXT_START, currentSplitText => currentSplitText);
...
export default createReducer(initialState, {
  ...
  [CONTACT_STATE]: (state, { payload: currentContactState }) => {
    return { ...state, currentContactState: !currentContactState }
  },
  [CONTACT_STATE_FALSE]: (state, { payload: currentContactState }) => {
    return { ...state, currentContactState: currentContactState }
  },
  [BUTTON_DELAY]: (state, { payload: currentButtonDelay }) => {
    return { ...state, currentButtonDelay: currentButtonDelay }
  },
  [GNB_STATE]: (state, { payload: currentGnbState }) => {
    return { ...state, currentGnbState: !currentGnbState }
  },
  [SWITCH_ANIMATION]: (state, { payload: currentSwitchAnimation }) => {
    return { ...state, currentSwitchAnimation: currentSwitchAnimation }
  },
  [FIRM_STATE]: (state, { payload: currentFilmState }) => {
    return { ...state, currentFilmState: currentFilmState }
  },
  [SMOOTH_TOP]: (state, { payload: currentSmoothTopState }) => {
    return { ...state, currentSmoothTopState: currentSmoothTopState }
  },
  [MAKE_SCROLL_STATE]: (state, { payload: makeScrollState }) => {
    return { ...state, makeScrollState: makeScrollState }
  },
  [CURRENT_SCROLL_VALUE]: (state, { payload: currentScrollValue }) => {
    return { ...state, currentScrollValue: currentScrollValue }
  },
  [CURRENT_SCROLL_LIMIT]: (state, { payload: currentScrollLimit }) => {
    return { ...state, currentScrollLimit: currentScrollLimit }
  },
  [GSAP_READY]: (state, { payload: currentGsapState }) => {
    return { ...state, currentGsapState: currentGsapState }
  },
  [SPLIT_TEXT_START]: (state, { payload: currentSplitText }) => {
    return { ...state, currentSplitText: currentSplitText }
  },
})
